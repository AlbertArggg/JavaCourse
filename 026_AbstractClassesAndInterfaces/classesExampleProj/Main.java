...
{	
	...
	public static void main(String[] args) 
	{
		...
		Student s = new Student("albert", 324, "alb123", "3wwdf", 87.8f);	// create and print a Student object
		System.out.println(s);
		s.printBarbie();
		
		//Prof p = new Prof("Jay", 226, "Jay123", "wkefhb", 32000);		// create and print a Prof object
